...
namespace Photon {
    ...
    void Application::render() {
        ...
        vkResetCommandPool(m_device, res.command_pool, 0);

        VkSemaphore image_acquire_semaphore = m_frame_resources[frame_res_index].image_acquired_semaphore;
        u32 image_index{ 0 };
        VkResult acquire_result = vkAcquireNextImageKHR(m_device, m_swapchain, UINT64_MAX, image_acquire_semaphore, VK_NULL_HANDLE, &image_index);
        ...
        VkRenderingAttachmentInfo color_attachment_info{
            ...
            .imageView = m_swapchin_image_views[image_index],
        ...
        VkRenderingInfo rendering_info{
            ...
            .renderArea{
                .offset{.x = 0, .y = 0},
                .extent{.width = m_swapchain_width, .height = m_swapchain_height}
            },
            .layerCount = 1,
        ...
        VkViewport viewport{
            .x = 0,
            .y = static_cast<f32>(m_swapchain_height),
            .width = static_cast<f32>(m_swapchain_width),
            .height = -static_cast<f32>(m_swapchain_height)
        };
        ...
        vector<VkSemaphoreSubmitInfo> semaphore_signals{
            {
                .sType = VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO,
                .semaphore = m_render_complete_semaphores[image_index],
        ...
        vkQueueSubmit2(m_graphics_queue, 1, &submit_info, VK_NULL_HANDLE);

        VkPresentInfoKHR present_info{
            .sType = VK_STRUCTURE_TYPE_PRESENT_INFO_KHR,
            .waitSemaphoreCount = 1,
            .pWaitSemaphores = &m_render_complete_semaphores[image_index],
            .swapchainCount = 1,
